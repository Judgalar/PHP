...
<div class="container">
  ...
  <form action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method = "POST">
    <input type="text" class="email" placeholder="email" value = "<?php if(isset($usuario))echo $usuario;?>"
			id = "usuario" name = "usuario">
    <br/>
    <input class="pwd" placeholder="password" id = "clave" name = "clave" type = "password">
