<!-- (7oct22) Programa anterior pero definiendo primero la función TerminoFibonacci.

Dicha función recibe un entero correspondiente a una posición y devuelve o retorna (no escribe) el término de la serie de Fibonacci que ocupa esa posición. Para resolverlo usará un bucle FOR. 
En el programa se llamará a dicha función.  -->
